...
@on_message(["image", "img"], allow_stan=True, Bad_user=True)
...
@on_message("wallpaper", allow_stan=True, Bad_user=True)
...
@on_message("glitch", allow_stan=True, Bad_user=True)
...
@on_message("deepfry", allow_stan=True, Bad_user=True)
