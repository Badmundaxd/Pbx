...
@on_message("kang", allow_stan=True, Bad_user=True)
...
@on_message("packkang", allow_stan=True, Bad_user=True)
...
@on_message("stickerinfo", allow_stan=True, Bad_user=True)
...
@on_message("rmsticker", allow_stan=True, Bad_user=True)
