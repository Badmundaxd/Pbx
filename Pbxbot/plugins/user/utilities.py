...
@on_message("readimage", allow_stan=True, Bad_user=True)
...
@on_message(["removebg", "rmbg"], allow_stan=True, Bad_user=True)
...
@on_message("paste", allow_stan=True, Bad_user=True)
...
@on_message("exchangerate", allow_stan=True, Bad_user=True)
...
@on_message("currency", allow_stan=True, Bad_user=True)
...
@on_message("currencies", allow_stan=True, Bad_user=True)
