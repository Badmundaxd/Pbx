...
@on_message("ppurge", allow_stan=True, Bad_user=True)
...
@on_message("ppurgeme", allow_stan=True, Bad_user=True)
...
@on_message("ppurgeuser", allow_stan=True, Bad_user=True)
...
@on_message("ddel", allow_stan=True, Bad_user=True)
...
@on_message(["selfdestruct", "sd"], allow_stan=True, Bad_user=True)
