...
@on_message("base64enc", allow_stan=True, Bad_user=True)
...
@on_message("base64dec", allow_stan=True, Bad_user=True)
...
@on_message(["calculate", "calc"], allow_stan=True, Bad_user=True)
...
@on_message("math", allow_stan=True, Bad_user=True)
...
@on_message("unpack", allow_stan=True, Bad_user=True)
...
@on_message("pack", allow_stan=True, Bad_user=True)
...
@on_message("calendar", allow_stan=True, Bad_user=True)
