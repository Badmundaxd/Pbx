...
@on_message("stog", allow_stan=True, Bad_user=True)
...
@on_message("stoi", allow_stan=True, Bad_user=True)
...
@on_message("itos", allow_stan=True, Bad_user=True)
...
@on_message("ftoi", allow_stan=True, Bad_user=True)
...
@on_message("itof", allow_stan=True, Bad_user=True)
...
@on_message("tovoice", allow_stan=True, Bad_user=True)
...
@on_message("tomp3", allow_stan=True, Bad_user=True)
