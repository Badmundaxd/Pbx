...
@on_message("autopost", chat_type=group_n_channel, allow_stan=True, Bad_user=True)
...
@on_message("stopautopost", chat_type=group_n_channel, allow_stan=True, Bad_user=True)
...
@on_message("autoposts", chat_type=group_n_channel, allow_stan=True, Bad_user=True)
