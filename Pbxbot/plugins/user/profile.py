...
@on_message("autoname", allow_stan=True, Bad_user=True)
...
@on_message("getpfp", allow_stan=True, Bad_user=True)
...
@on_message("setpfp", allow_stan=True, Bad_user=True)
...
@on_message("setusername", allow_stan=True, Bad_user=True)
...
@on_message("delpfp", allow_stan=True, Bad_user=True)
...
@on_message("github", allow_stan=True, Bad_user=True)
...
HelpMenu("profile").add(
    ...
    "setbio Embracing the Pbxbot 4.0.",
    "To remove the bio dont pass any argument.",
).add(
    "setname", "<new name>", "Set the name of the bot.", "setname Pbxbot 4.0"
).add(
    "setusername",
    "<new username>",
    "Set the username of the bot.",
    "setusername Pbxbot 4.0",
