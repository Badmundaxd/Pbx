...
@on_message("count", allow_stan=True, Bad_user=True)
...
@on_message("stats", allow_stan=True, Bad_user=True)
...
@on_message("reserved", allow_stan=True, Bad_user=True)
...
@on_message("info", allow_stan=True, Bad_user=True)
