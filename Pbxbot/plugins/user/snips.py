...
@on_message(["snip", "note"], allow_stan=True, Bad_user=True)
...
@on_message(["rmsnip", "rmallsnip"], allow_stan=True, Bad_user=True)
...
@on_message(["getsnip", "snips"], allow_stan=True, Bad_user=True)
