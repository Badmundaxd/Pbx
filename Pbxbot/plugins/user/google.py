...
@on_message("wikipedia", allow_stan=True, Bad_user=True)
...
@on_message("google", allow_stan=True, Bad_user=True)
...
@on_message("reverse", allow_stan=True, Bad_user=True)
...
@on_message("gps", allow_stan=True, Bad_user=True)
...
@on_message("webshot", allow_stan=True, Bad_user=True)
async def webScreenshot(_, message: Message):
    ...
    with io.BytesIO(image) as result:
        result.name = "Pbxbot 4.0_Webshot.png"
        await Pbx.reply_document(result)
        await Pbx.delete()

    try:
        os.remove("Pbxbot 4.0_Webshot.png")
    except:
        pass


@on_message("cricket", allow_stan=True, Bad_user=True)
...
@on_message(["dictionary", "meaning"], allow_stan=True, Bad_user=True)
...
@on_message(["translate", "tr"], allow_stan=True, Bad_user=True)
...
@on_message("trcode", allow_stan=True, Bad_user=True)
...
@on_message(["voice", "tts"], allow_stan=True, Bad_user=True)
...
@on_message("movie", allow_stan=True, Bad_user=True)
...
HelpMenu("google").add(
    ...
    "google", "<query>", "Searches for the given query on google.", "google the Pbxbot 4.0"
).add(
    "reverse",
