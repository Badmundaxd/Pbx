...
@on_message("lock", admin_only=True, allow_stan=True, Bad_user=True)
...
@on_message("unlock", admin_only=True, allow_stan=True, Bad_user=True)
...
@on_message("locktypes", allow_stan=True, Bad_user=True)
