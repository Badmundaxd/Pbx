...
@on_message("mediainfo", allow_stan=True, Bad_user=True)
...
@on_message(["mmf", "memify"], allow_stan=True, Bad_user=True)
async def memify(_, message: Message):
    ...
    await message.reply_photo(
        memes[0],
        caption=f"**🍀 𝖬𝖾𝗆𝗂𝖿𝗂𝖾𝖽 𝗎𝗌𝗂𝗇𝗀 PBXBOT 4.0!**",
    )
...
@on_message("rename", allow_stan=True, Bad_user=True)
