...
@on_message("anime", allow_stan=True, Bad_user=True)
...
@on_message("manga", allow_stan=True, Bad_user=True)
...
@on_message("character", allow_stan=True, Bad_user=True)
...
@on_message("airing", allow_stan=True, Bad_user=True)
...
@on_message(["anilistuser", "aniuser"], allow_stan=True, Bad_user=True)
...
@on_message(["filler", "canon"], allow_stan=True, Bad_user=True)
...
@on_message("watchorder", allow_stan=True, Bad_user=True)
