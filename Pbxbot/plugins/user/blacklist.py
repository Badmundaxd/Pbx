...
from . import HelpMenu, custom_handler, db, Pbxbot, on_message, Bad


@on_message("blacklist", admin_only=True, allow_stan=True, Bad_user=True)
@Bad
...
@on_message("unblacklist", admin_only=True, allow_stan=True, Bad_user=True)
...
@on_message("blacklists", admin_only=True, allow_stan=True, Bad_user=True)
